...
// //     welcomeMessage: "( Welcome 🙏)", // Welcome meWelcomessage for Gurugram
// //   },
// //   {
// //     city: "Mumbai",
// //     backgroundImage: mumbai,
...
//     city: "Bengaluru",
//     backgroundImage: mumbai,
//     overlayColor: "from-pink-500/60",
//     welcomeMessage: "( Namaskara 🙏)",
//   },
//   {
//     city: "Pune",
//     backgroundImage: bangalore,
//     overlayColor: "from-purple-500/60",
//     welcomeMessage: "( स्वागत आहे 🙏)",
//   },
//   {
//     city: "Hyderabad",
//     backgroundImage: hyderabad,
//     overlayColor: "from-yellow-500/60",
//     welcomeMessage: "( Swagatam 🙏)",
//   },
//   {
//     city: "Gurugram",
//     backgroundImage: chennai,
//     overlayColor: "from-blue-500/60",
...
//   return (
//     <div className="p-4 sm:p-8 max-w-7xl mx-auto" id="venue">
//       {/* Title Section */}
//       <div className="text-center mb-8">
//         <h1 className="text-2xl sm:text-3xl font-bold text-[#FFFFFF] mb-4 mt-6">
//           <span className="text-[#ebff00]">Mr. Vimal Daga</span> on India{" "}
//           <Image src={indiaFlag} alt="India Flag" width={30} height={25} className="inline-block" />
//           {" "}Tour
//         </h1>
//         <div className="h-1 w-16 bg-red-500 mx-auto"></div>
//       </div>
...
//           <div
//             key={index}
//             className="relative overflow-hidden rounded-lg shadow-lg transition-transform duration-500 transform hover:scale-105 h-96 group"
//             onMouseEnter={() => setHoveredIndex(index)}
//             onMouseLeave={() => setHoveredIndex(null)}
//           >
//             {/* Background Image */}
...
//                   {events.map((event, eventIndex) => (
//                     <li key={eventIndex} className="flex items-center gap-2 text-sm">
//                       <BadgeCheck className="inline text-sm" />
//                       {event}
//                     </li>
//                   ))}
//                 </ul>
...
//               {city.city === "Bengaluru" ? (
//                 <a href="#">
//                   <div className="m-4 py-2 px-4 w-full hover:border text-white font-semibold rounded-lg bg-white/40 hover:bg-white/70 hover:text-black text-center leading-none">
//                     10th - 12th Jan, 2025
//                     <br />
//                     <span className="text-[10px] bg-[#ff0000]">(Venue will be announced soon...)</span>
//                   </div>
...
//               ) : (
//                 <a href="#">
//                   <div className="mt-4 py-2 px-4 w-full hover:border text-white font-semibold rounded-lg bg-white/10 hover:bg-white/20 text-center leading-none">
//                     To be announced
//                     <br />
//                     <span className="text-[10px] bg-[#ff0000]">(Venue will be announced soon...)</span>
//                   </div>
