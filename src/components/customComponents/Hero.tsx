...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden md:max-w-7xl mx-auto">
      ...
      >
        <div className="absolute inset-0 bg-black opacity-10" /> {/* Dark overlay */}
      </div>

      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 md:px-8 -mt-16">
